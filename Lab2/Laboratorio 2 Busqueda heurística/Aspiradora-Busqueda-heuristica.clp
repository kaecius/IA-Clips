...
?*ESTADO-INICIAL* = (create$ h1 aspiradora sucia sucia  h2 sucia sucia sucia sucia cop )
 ...
 ?*PASOS* = 0 
;indica que no hay límite en el número de pasos
)


;;;EXPLICACIÓN DE UN ESTADO ARBITRARIO
;sistema-aspiradora: lista (h1 aspiradora sucia h2 sucia cop I D I)
;h1 aspiradora sucia: indica que la aspiradora está  y que la habitación está sucia
;h2 sucia: la habitación de la derecha está sucia y la aspiradora no está  
